(function($, Drupal, drupalSettings) {
  Drupal.behaviors.timeoutnotifier = {
    attach: function () {
      ...
      localStorage.setItem('session_timeout', maxLifetime + Math.floor(new Date().getTime() / 1000));
      // Dismiss any current timeout notifications on all tabs.
      DismissNotification();
      // Get time till expire
      const timeTillExpire = parseInt(drupalSettings.timeout_notification.timeout_notifier.time_till_expire);
